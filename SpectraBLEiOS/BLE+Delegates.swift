...
extension [String : Any] {
    ...
    func inOutFlag(_ strManuf: String) -> String {
        guard strManuf.count >= 10 else { return "" }
        let startIndex = strManuf.index(strManuf.startIndex, offsetBy: 8)
        let endIndex = strManuf.index(startIndex, offsetBy: 2)
        return String(strManuf[startIndex..<endIndex])
    }
